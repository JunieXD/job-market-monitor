...
class Settings(BaseSettings):
    ...
    mihoyo_request_delay_seconds: float = Field(default=0.5, ge=0.5, le=30)
    lilith_request_delay_seconds: float = Field(default=1.5, ge=0.5, le=30)
    hupu_request_delay_seconds: float = Field(default=1.5, ge=0.5, le=30)
